package com.scu.charles.viewpageindicator.widget;
...
import com.scu.charles.viewpageindicator.utils.AnimatorUtils;
...
public class RhythmLayout extends HorizontalScrollView{
    ...
    private int getFirstVisibleItemPosition() {
        ...
        for(int i=0;i<size;i++){
            ...
            //当出现按钮的x轴比当前ScrollView的x轴大时，这个按钮就是当前可见的第一个
